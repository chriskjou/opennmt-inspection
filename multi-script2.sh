#!/bin/bash
#SBATCH -J multi_script_test2  					# Job name
#SBATCH -p seas_dgx1 							# partition (queue)
#SBATCH --gres=gpu:1							# for GPU
#SBATCH --mem 10000 							# memory pool for all cores
#SBATCH -t 0-24:00 								# time (D-HH:MM)
#SBATCH --output=/n/home10/cjou/projects 		# file output location
#SBATCH -o ../../outpt_multi_script_test2.txt 			# File that STDOUT writes to
#SBATCH -e ../../err_multi_script_test2.txt				# File that STDERR writes to
