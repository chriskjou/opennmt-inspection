#!/bin/bash
#SBATCH -J single_batch_rank_test		  		# Job name
#SBATCH -p seas_dgx1 							# partition (queue)
#SBATCH --mem 10000 							# memory pool for all cores
#SBATCH -t 0-24:00 								# time (D-HH:MM)
#SBATCH --output=/n/home10/cjou/projects 		# file output location
#SBATCH -o ../../rank_logs/outpt_single_batch_rank_test.txt 			# File that STDOUT writes to
#SBATCH -e ../../rank_logs/err_single_batch_rank_test.txt			# File that STDERR writes to
