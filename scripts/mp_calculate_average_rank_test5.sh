#!/bin/bash
#SBATCH -J mp_entire_pickle32_5  				# Job name
...
#SBATCH -o ../../../outpt_mp_entire_pickle32_5.txt 		# File that STDOUT writes to
#SBATCH -e ../../../err_mp_entire_pickle32_5.txt		# File that STDERR writes to
