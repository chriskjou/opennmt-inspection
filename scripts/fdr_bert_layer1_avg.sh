#!/bin/bash
#SBATCH -J fdr_bert_layer1_avg  				# Job name
#SBATCH -p seas_dgx1 							# partition (queue)
#SBATCH --mem 3000 								# memory pool for all cores
#SBATCH -t 0-24:00 								# time (D-HH:MM)
#SBATCH --output=/n/home10/cjou/projects 		# file output location
#SBATCH -o ../../../outpt_fdr_bert_layer1_avg.txt 			# File that STDOUT writes to
#SBATCH -e ../../../err_fdr_bert_layer1_avg.txt				# File that STDERR writes to
