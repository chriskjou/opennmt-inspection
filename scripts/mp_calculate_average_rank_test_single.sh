#!/bin/bash
#SBATCH -J mp_entire_pickle_map  		# Job name
...
#SBATCH -o ../../../outpt_mp_entire_pickle_map.txt 		# File that STDOUT writes to
#SBATCH -e ../../../err_mp_entire_pickle_map.txt		# File that STDERR writes to
