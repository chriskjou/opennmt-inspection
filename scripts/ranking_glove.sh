...
python ../batch_calculate_rank_across_sentences.py --embedding_layer /n/shieber_lab/Lab/users/cjou/embeddings/parallel/spanish/2layer-brnn/avg/parallel-english-to-spanish-model-2layer-brnn-pred-layer1-avg.mat --cross_validation --model_to_brain --total_batches 100 --glove